...
if store.card_lvl_metal >=4 {draw_text_ext(x+160,y-4,"MAX",15,86)}
...
if store.card_lvl_pinata >=4 {draw_text_ext(x+160,y-4,"MAX",15,86)}
draw_set_color(c_white)
...
if store.card_lvl_fetch  >=4 {draw_text_ext(x+160,y-4,"MAX",15,86)}
draw_set_color(c_white)
...
if store.card_lvl_pizza >=4 {draw_text_ext(x+160,y-4,"MAX",15,86)}
draw_set_color(c_white)
...
if store.card_lvl_repulse >=4 {draw_text_ext(x+160,y-4,"MAX",15,86)}
draw_set_color(c_white)
...
if store.card_lvl_critgold >=4 {draw_text_ext(x+160,y-4,"MAX",15,86)}
draw_set_color(c_white)
