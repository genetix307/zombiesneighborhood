...
//Spawn Enemies
if hud.run_minutes>=1 and hud.run_seconds<55 {spawn_zombie_suit-=1}
...
if hud.run_minutes>=0 {spawn_spirit_ghost-=1}
...
if hud.run_seconds>=45 and hud.run_minutes>8 {spawn_mummy_ground-=1}
...
if hud.run_minutes>=3 {spawn_winged_stinger-=1}
...
if hud.run_minutes>=2 {spawn_zombie_gusher-=1}
...
if hud.run_minutes>=10 {spawn_vampire_vlad-=1}
...
if hud.run_minutes>=3 and hud.run_seconds>20 {spawn_monster_prototype-=1}
...
if hud.run_minutes>=0 and hud.run_seconds>40 {spawn_skeleton_bonejamin-=1}
...
if hud.run_minutes>=3 {spawn_boss_boogie-=1}
