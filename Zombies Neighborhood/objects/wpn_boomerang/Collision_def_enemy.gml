...
damaged=hud.boomerang_damaged_delay
repeat 5 instance_create_depth(x,y,depth,effect_blood_splatter)
instance_create_depth(x,y,depth,show_small_hit)
//knockback
if boss=0 {mp_potential_step_object(player.x,player.y,-hud.boomerang_knockback,def_solid)}
}
}

if hud.boomerang_pierce = "No" {instance_destroy()}
