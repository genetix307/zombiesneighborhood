...
knife_base_damage = 5 //Base Damage
...
knife_damaged_delay = 10 //Time until can damage enemy again
...
firebomb_damaged_delay = 20 //Time until can damage enemy again
...
bloodknife_damaged_delay = 10 //Time until can damage enemy again
...
boomerang_damaged_delay = 20 //Time until can damage enemy again
...
shotgun_pierce = "No" //Go through enemies
shotgun_cooldown = 80 //Time to set canuse to
shotgun_damaged_delay = 0 //Time until can damage enemy again
...
valari_damaged_delay = 15 //Time until can damage enemy again
