...
damaged=hud.slogun_damaged_delay
repeat 5 instance_create_depth(x,y,depth,effect_blood_splatter)
instance_create_depth(x,y,depth,show_small_hit)
//knockback
if boss=0 {mp_potential_step_object(player.x,player.y,-hud.slogun_knockback,def_solid)}
//Slow
if boss=0 {slow=290}
}
critical=0
...
if hud.slogun_pierce = "No" {instance_destroy()}
