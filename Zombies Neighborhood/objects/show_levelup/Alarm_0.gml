...
total_choices=30.99 //UPDATE THIS WHEN ADDING NEW CHOICE
...
instance_create_depth(cx+85,cy+330,depth-10,btn_lvl_upgrade).my_id=slot_1
instance_create_depth(cx+85,cy+410,depth-10,btn_lvl_upgrade).my_id=slot_2
instance_create_depth(cx+85,cy+490,depth-10,btn_lvl_upgrade).my_id=slot_3
